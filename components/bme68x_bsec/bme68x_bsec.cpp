...
#include "config/bme680/bme680_iaq_33v_300s_28d/bsec_iaq.txt"
      ...
      this->bsec_status_ = bsec_set_configuration_m(&this->bsec_instance_, config, BSEC_MAX_PROPERTY_BLOB_SIZE, work_buffer, sizeof(work_buffer));
    } else {  // SUPPLY_VOLTAGE_1V8
      const uint8_t config[] = {
#include "config/bme680/bme680_iaq_18v_300s_28d/bsec_iaq.txt"
      };
      this->bsec_status_ = bsec_set_configuration_m(&this->bsec_instance_, config, BSEC_MAX_PROPERTY_BLOB_SIZE, work_buffer, sizeof(work_buffer));
    }
  } else {  // SAMPLE_RATE_LP
    if (this->supply_voltage_ == SUPPLY_VOLTAGE_3V3) {
      const uint8_t config[] = {
#include "config/bme680/bme680_iaq_33v_3s_28d/bsec_iaq.txt"
      };
      this->bsec_status_ = bsec_set_configuration_m(&this->bsec_instance_, config, BSEC_MAX_PROPERTY_BLOB_SIZE, work_buffer, sizeof(work_buffer));
    } else {  // SUPPLY_VOLTAGE_1V8
      const uint8_t config[] = {
#include "config/bme680/bme680_iaq_18v_3s_28d/bsec_iaq.txt"
      };
      this->bsec_status_ = bsec_set_configuration_m(&this->bsec_instance_, config, BSEC_MAX_PROPERTY_BLOB_SIZE, work_buffer, sizeof(work_buffer));
    }
  }
